# NEXUS_DATAPLATFORM-PIPELINE

This folder defines all source code for the 'NEXUS_DATAPLATFORM-PIPELINE' pipeline:
...
* Take a look at the sample under "sample_users_nexus_dataplatform_pipeline.py" to get familiar with the syntax.
